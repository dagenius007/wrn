...
const routes = [
  ...
  {
    path: "/cases/:type",
    component: loadable(() => import("new-pages/cases/Cases")),
    exact: true
  },
  {
    path: "/cases/case/:id",
    component: loadable(() => import("new-pages/cases/Case")),
    exact: true
  },
  {
    path: "/contact",
  ...
  {
    path: "/dashboard/supremeCases",
    component: loadable(() => import("new-pages/dashboard/Dashboard")),
    exact: true
  },
  {
    path: "/dashboard/case/:id",
    component: loadable(() => import("new-pages/dashboard/judgements/Case")),
    exact: true
  },
  // {
  // 	path: '/dashboard/constitutions/:type',
  // 	component: loadable(() => import('new-pages/dashboard/constitutions/Constution')),
  // 	exact: true,
  // },
  {
    path: "/dashboard/constitutions/create",
    component: loadable(() =>
      import("new-pages/dashboard/constitutions/create/index")
    ),
    exact: true
  },
  {
